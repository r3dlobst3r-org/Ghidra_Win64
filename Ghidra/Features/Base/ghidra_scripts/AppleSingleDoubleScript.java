 ...
 */
//Given a raw binary Apple Single/Double image,
...
public class AppleSingleDoubleScript extends GhidraScript {

	@Override
	public void run() throws Exception {
		AppleSingleDoubleBinaryAnalysisCommand command = new AppleSingleDoubleBinaryAnalysisCommand();
