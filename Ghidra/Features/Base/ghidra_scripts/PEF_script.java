 ...
 */
//Mac OS Preferred Executable Format (PEF)
//Given a raw binary PEF image,
...
public class PEF_script extends GhidraScript {

	@Override
	public void run() throws Exception {
		PefBinaryAnalysisCommand command = new PefBinaryAnalysisCommand();
